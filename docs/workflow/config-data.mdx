...
<Note>
This is for **config data**: small tables that the application reads and the deployment owns. For backfills and other one-off changes to user data, see [Data Migration](/workflow/data-migration).
</Note>
