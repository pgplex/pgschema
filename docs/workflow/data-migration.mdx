...
<Note>
Small lookup and configuration tables are the exception: keep their rows in CSV files declared with [`\copy`](/syntax/copy) and pgschema plans the row changes for you. See [Reference Data](/workflow/reference-data). This page covers one-off changes to data that pgschema does not own.
</Note>
