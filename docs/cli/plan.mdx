...
1. Compare the two states, including the rows of config tables declared with [`\copy`](/syntax/copy) directives
...
See [Config Data](/workflow/config-data) for details.
