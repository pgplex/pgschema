...
Building a declarative schema migration tool for Postgres means you eventually meet syntax most schema files never write. Below I've picked the five most intriguing from our 200+ closed user reports.
