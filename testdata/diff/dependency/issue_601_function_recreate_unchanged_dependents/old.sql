...
CREATE FUNCTION audit_threshold() RETURNS integer LANGUAGE sql IMMUTABLE AS $$ SELECT 10 $$;
...
CREATE FUNCTION standalone() RETURNS integer LANGUAGE sql IMMUTABLE AS $$ SELECT 1 $$;
